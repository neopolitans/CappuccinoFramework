...
// This script adds the ability to draw a solo 2D Arrow to the Visualizer Toolkit.
// Shorthand for GizmoUtilities > DrawArrow2D.cs
...
namespace Cappuccino
{
    namespace Core
    {
        ...
        {
            /// <summary>
            /// <see langword="Cappuccino:"/> Draw a 2D Arrow.
            /// </summary>
            /// <param name="start">The start position of the arrow.</param>
            /// <param name="end">The end position of the arrow.</param>
            public static void Arrow2D(Vector3 start, Vector3 end)
            {
                GT.DrawArrow2D(start, end, 30f, 3f, 0.5f);
            }
            ...
            public static void Arrow2D(Vector3 start, Vector3 end, float arrowheadAngle)
            {
                GT.DrawArrow2D(start, end, arrowheadAngle, 3f, 0.5f);
            }
            ...
            public static void Arrow2D(Vector3 start, Vector3 end, float arrowheadAngle, float arrowheadDistance)
            {
                GT.DrawArrow2D(start, end, arrowheadAngle, arrowheadDistance, 0.5f);
            }
            ...
            public static void Arrow2D(Vector3 start, Vector3 end, float arrowheadAngle, float arrowheadDistance, float arrowheadLength)
            {
                GT.DrawArrow2D(start, end, arrowheadAngle, arrowheadDistance, arrowheadLength);
            }
        }
    }
}
